...
import com.ddona.mvvm.util.PAGE_SIZE
...
class BaseRecyclerView constructor(
    ...
    private var onAdapterLoadFinish: ((loadNewItemVisible: Boolean, needScroll: Boolean) -> Unit)? =
        null
    ...
    private val onScrollMore =
        EndlessRecyclerViewScrollListener { if (it >= PAGE_SIZE) onLoadMore?.invoke() }
...
fun RecyclerView.addDivider(
    ...
    dividerColorAttr: Int = R.color.light_divider,
